...
final class LLMCleanup: Sendable {
    ...
    private static let basePrompt = """
        You are a transcript cleaner. The transcript is spoken by a Turkish software developer who mixes Turkish and English (code-switching). Your ONLY job: remove filler words (şey, yani, ee, ıı, hani, um, uh) and fix punctuation/casing.
